    ...
    var body: [String: Any] {
        ...
        case .post(let myData, let isCaptured, let cast):
            ...
            let userData: [String: Any] = [
                ...
                "nasilsinNow": myData.isVpn,
                "nowGorusuruzMit": myData.uniqueNumber,
                "MeetKutuOldu": myData.wifiAddress,
                "olduGuzelSimdi": myData.isCharging,
            ]
